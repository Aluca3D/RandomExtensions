...
public class DeGen extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(Weapons.WOODEN_LONGSWORD, "Holzlangschwert ");
        translationBuilder.add(Weapons.STONE_LONGSWORD, "Steinlangschwert ");
        translationBuilder.add(Weapons.IRON_LONGSWORD, "Eisenlangschwert ");
        translationBuilder.add(Weapons.COPPER_LONGSWORD, "Kupferlangschwert ");
        translationBuilder.add(Weapons.GOLDEN_LONGSWORD, "Goldenlangschwert ");
        translationBuilder.add(Weapons.DIAMOND_LONGSWORD, "Diamantlangschwert ");
        translationBuilder.add(Weapons.NETHERITE_LONGSWORD, "Netheritlangschwert ");
        translationBuilder.add(Tools.WOODEN_PAXEL, "Holz Paxel");
        translationBuilder.add(Tools.STONE_PAXEL, "Stein Paxel");
        translationBuilder.add(Tools.IRON_PAXEL, "Eisen Paxel");
        translationBuilder.add(Tools.COPPER_PAXEL, "Kupfer Paxel");
        translationBuilder.add(Tools.GOLDEN_PAXEL, "Golden Paxel");
        translationBuilder.add(Tools.DIAMOND_PAXEL, "Diamant Paxel");
        translationBuilder.add(Tools.NETHERITE_PAXEL, "Netherit Paxel");
        translationBuilder.add(Tools.COPPER_AXE, "Kupferaxt");
        translationBuilder.add(Tools.COPPER_PICKAXE, "Kupferspitzhacke");
        translationBuilder.add(Tools.COPPER_SHOVEL, "Kupferschaufel");
        translationBuilder.add(Tools.COPPER_HOE, "Kupferhacke");
        translationBuilder.add(Weapons.COPPER_SWORD, "Kupferschwert");
        translationBuilder.add(Armors.COPPER_HELMET, "Kupferhelm");
        translationBuilder.add(Armors.COPPER_CHESTPLATE, "Kupferharnisch");
        translationBuilder.add(Armors.COPPER_LEGGINGS, "Kupferbeinschutz");
        translationBuilder.add(Armors.COPPER_BOOTS, "Kupferstiefel");
        translationBuilder.add(Armors.SHULKER_HELMET, "Shulkerhelm");
        translationBuilder.add(Armors.SHULKER_CHESTPLATE, "Shulkerharnisch");
        translationBuilder.add(Armors.SHULKER_LEGGINGS, "Shulkerbeinschutz");
        translationBuilder.add(Armors.SHULKER_BOOTS, "Shulkerstiefel");
        translationBuilder.add(Armors.D_AQUAMARIN_HELMET, "Aquamarin Diamanthelm");
        translationBuilder.add(Armors.D_AQUAMARIN_CHESTPLATE, "Aquamarin Diamantharnisch");
        translationBuilder.add(Armors.D_AQUAMARIN_LEGGINGS, "Aquamarin Diamantbeinschutz");
        translationBuilder.add(Armors.D_AQUAMARIN_BOOTS, "Aquamarin Diamantstiefel");
        translationBuilder.add(Armors.N_AQUAMARIN_HELMET, "Aquamarin Netherithelm");
        translationBuilder.add(Armors.N_AQUAMARIN_CHESTPLATE, "Aquamarin Netheritharnisch");
        translationBuilder.add(Armors.N_AQUAMARIN_LEGGINGS, "Aquamarin Netheritbeinschutz");
        translationBuilder.add(Armors.N_AQUAMARIN_BOOTS, "Aquamarin Netheritstiefel");
        translationBuilder.add(Armors.D_RUBY_HELMET, "Rubin Diamanthelm");
        translationBuilder.add(Armors.D_RUBY_CHESTPLATE, "Rubin Diamantharnisch");
        translationBuilder.add(Armors.D_RUBY_LEGGINGS, "Rubin Diamantbeinschutz");
        translationBuilder.add(Armors.D_RUBY_BOOTS, "Rubin Diamantstiefel");
        translationBuilder.add(Armors.N_RUBY_HELMET, "Rubin Netherithelm");
        translationBuilder.add(Armors.N_RUBY_CHESTPLATE, "Rubin Netheritharnisch");
        translationBuilder.add(Armors.N_RUBY_LEGGINGS, "Rubin Netheritbeinschutz");
        translationBuilder.add(Armors.N_RUBY_BOOTS, "Rubin Netheritstiefel");
        translationBuilder.add(Armors.D_TOPAS_HELMET, "Topas Diamanthelm");
        translationBuilder.add(Armors.D_TOPAS_CHESTPLATE, "Topas Diamant harnisch");
        translationBuilder.add(Armors.D_TOPAS_LEGGINGS, "Topas Diamantbeinschutz");
        translationBuilder.add(Armors.D_TOPAS_BOOTS, "Topas Diamantstiefel");
        translationBuilder.add(Armors.N_TOPAS_HELMET, "Topas Netherithelm");
        translationBuilder.add(Armors.N_TOPAS_CHESTPLATE, "Topas Netheritharnisch");
        translationBuilder.add(Armors.N_TOPAS_LEGGINGS, "Topas Netheritbeinschutz");
        translationBuilder.add(Armors.N_TOPAS_BOOTS, "Topas Netheritstiefel");
        ...
        translationBuilder.add(Specials.TOY_HAMMER, "Spielzeughammer");
        translationBuilder.add(Specials.ESCAPE_ROPE, "Rettungsseil");
        translationBuilder.add(Specials.LEAVE_STAFF, "Blatt Stab");
        ...
        translationBuilder.add(AccessorieItems.SUNGLASSES, "Sonnenbrille");
        translationBuilder.add(AccessorieItems.BOATER, "Steife Strohhut");
        translationBuilder.add(AccessorieItems.TOP_HAT, "Zylinder");
        translationBuilder.add(AccessorieItems.TOP_TOP_HAT, "Grosser Zylinder");
        translationBuilder.add(AccessorieItems.DEVIL_HORNS, "Teufel Hörner");
