...
public class EnUsGen extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(Weapons.WOODEN_LONGSWORD, "Wooden Longsword");
        translationBuilder.add(Weapons.STONE_LONGSWORD, "Stone Longsword");
        translationBuilder.add(Weapons.IRON_LONGSWORD, "Iron Longsword");
        translationBuilder.add(Weapons.COPPER_LONGSWORD, "Copper Longsword");
        translationBuilder.add(Weapons.GOLDEN_LONGSWORD, "Golden Longsword");
        translationBuilder.add(Weapons.DIAMOND_LONGSWORD, "Diamond Longsword");
        translationBuilder.add(Weapons.NETHERITE_LONGSWORD, "Netherite Longsword");
        translationBuilder.add(Tools.WOODEN_PAXEL, "Wooden Paxel");
        translationBuilder.add(Tools.STONE_PAXEL, "Stone Paxel");
        translationBuilder.add(Tools.IRON_PAXEL, "Iron Paxel");
        translationBuilder.add(Tools.COPPER_PAXEL, "Copper Paxel");
        translationBuilder.add(Tools.GOLDEN_PAXEL, "Golden Paxel");
        translationBuilder.add(Tools.DIAMOND_PAXEL, "Diamond Paxel");
        translationBuilder.add(Tools.NETHERITE_PAXEL, "Netherite Paxel");
        translationBuilder.add(Tools.COPPER_AXE, "Copper Axe");
        translationBuilder.add(Tools.COPPER_PICKAXE, "Copper Pickaxe");
        translationBuilder.add(Tools.COPPER_SHOVEL, "Copper Shovel");
        translationBuilder.add(Tools.COPPER_HOE, "Copper Hoe");
        translationBuilder.add(Weapons.COPPER_SWORD, "Copper Sword");
        translationBuilder.add(Armors.COPPER_HELMET, "Copper Helmet");
        translationBuilder.add(Armors.COPPER_CHESTPLATE, "Copper Chestplate");
        translationBuilder.add(Armors.COPPER_LEGGINGS, "Copper Leggings");
        translationBuilder.add(Armors.COPPER_BOOTS, "Copper Boots");
        translationBuilder.add(Armors.SHULKER_HELMET, "Shulker Helmet");
        translationBuilder.add(Armors.SHULKER_CHESTPLATE, "Shulker Chestplate");
        translationBuilder.add(Armors.SHULKER_LEGGINGS, "Shulker Leggings");
        translationBuilder.add(Armors.SHULKER_BOOTS, "Shulker Boots");
        translationBuilder.add(Armors.D_AQUAMARIN_HELMET, "Aquamarin Diamond Helmet");
        translationBuilder.add(Armors.D_AQUAMARIN_CHESTPLATE, "Aquamarin Diamond Chestplate");
        translationBuilder.add(Armors.D_AQUAMARIN_LEGGINGS, "Aquamarin Diamond Leggings");
        translationBuilder.add(Armors.D_AQUAMARIN_BOOTS, "Aquamarin Diamond Boots");
        translationBuilder.add(Armors.N_AQUAMARIN_HELMET, "Aquamarin Netherite Helmet");
        translationBuilder.add(Armors.N_AQUAMARIN_CHESTPLATE, "Aquamarin Netherite Chestplate");
        translationBuilder.add(Armors.N_AQUAMARIN_LEGGINGS, "Aquamarin Netherite Leggings");
        translationBuilder.add(Armors.N_AQUAMARIN_BOOTS, "Aquamarin Netherite Boots");
        translationBuilder.add(Armors.D_RUBY_HELMET, "Ruby Diamond Helmet");
        translationBuilder.add(Armors.D_RUBY_CHESTPLATE, "Ruby Diamond Chestplate");
        translationBuilder.add(Armors.D_RUBY_LEGGINGS, "Ruby Diamond Leggings");
        translationBuilder.add(Armors.D_RUBY_BOOTS, "Ruby Diamond Boots");
        translationBuilder.add(Armors.N_RUBY_HELMET, "Ruby Netherite Helmet");
        translationBuilder.add(Armors.N_RUBY_CHESTPLATE, "Ruby Netherite Chestplate");
        translationBuilder.add(Armors.N_RUBY_LEGGINGS, "Ruby Netherite Leggings");
        translationBuilder.add(Armors.N_RUBY_BOOTS, "Ruby Netherite Boots");
        translationBuilder.add(Armors.D_TOPAS_HELMET, "Topas Diamond Helmet");
        translationBuilder.add(Armors.D_TOPAS_CHESTPLATE, "Topas Diamond Chestplate");
        translationBuilder.add(Armors.D_TOPAS_LEGGINGS, "Topas Diamond Leggings");
        translationBuilder.add(Armors.D_TOPAS_BOOTS, "Topas Diamond Boots");
        translationBuilder.add(Armors.N_TOPAS_HELMET, "Topas Netherite Helmet");
        translationBuilder.add(Armors.N_TOPAS_CHESTPLATE, "Topas Netherite Chestplate");
        translationBuilder.add(Armors.N_TOPAS_LEGGINGS, "Topas Netherite Leggings");
        translationBuilder.add(Armors.N_TOPAS_BOOTS, "Topas Netherite Boots");
        ...
        translationBuilder.add(Specials.TOY_HAMMER, "Toy Hammer");
        translationBuilder.add(Specials.ESCAPE_ROPE, "Escape Rope");
        translationBuilder.add(Specials.LEAVE_STAFF, "Leave Staff");
