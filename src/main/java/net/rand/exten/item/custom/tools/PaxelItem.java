...
public class PaxelItem extends MiningToolItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        useOnBlockShovel(context);
        useOnBlockAxe(context);
